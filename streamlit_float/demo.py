...
float_box(
    ...
    width="29rem", right="2rem", bottom=vid_y_pos, transition=0, shadow=12, css="padding: 0;")
...
float_box(
    '<a href="https://pypi.org/project/streamlit-float/">PYPI</a>・<a href="https://github.com/bouzidanas/streamlit-float">Github</a>・<a href="https://discuss.streamlit.io/t/anybody-interested-in-simple-component-to-float-containers/45013?u=bouzidanas">Community</a> ',
    width="fit-content", height="2rem", right="-5.6rem", top="12rem", background="transparent",
    css="flex-direction: row;align-items: center;color: #ffffff99;rotate: 90deg;")
...
if st.session_state.tutorial:
    ...
    float_box('<div>↑</div><div>Place Menus/Navbars in a container and float it to the top or bottom of the page</div>',
              width="30%", height="2rem", right="50%", top="3rem", background="transparent",
              css="max-width:50%;width:fit-content;flex-direction: column;align-items: center;color: #ffffff;font-size:1.8rem;z-index:999999;translate: 50%;")
    float_box('<div style="height:fit-content;">Click close button to exit tutorial </div><div>↴</div>', height="2rem",
              right="2.7rem", bottom="7.5rem", background="transparent",
              css="min-width: 25%; width:fit-content;flex-direction: row;justify-content: right;color: #ffffff;font-size:1.8rem;z-index:999999;gap:0.5rem;")